...
function App() {
  ...
  return (
    <div
      className="min-h-screen relative overflow-hidden bg-gradient-to-br from-indigo-950 via-purple-950 to-slate-900">
      ...
      <div
        ...
        <div
          className="stars"></div>
        <div
          className="stars2"></div>
        <div
          className="stars3"></div>
        
        {/* Nebula Effects */}
        <div
          className="absolute top-0 left-1/4 w-96 h-96 bg-purple-500/20 rounded-full blur-[120px] animate-pulse-slow"></div>
        <div
          className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-blue-500/20 rounded-full blur-[120px] animate-pulse-slower"></div>
        <div
          className="absolute top-1/2 left-1/2 w-96 h-96 bg-pink-500/10 rounded-full blur-[100px] animate-float"></div>
      </div>
      ...
      <div
        ...
        <header
          ...
          <div
            ...
            <div
              ...
              <div
                className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-40 h-40 border border-purple-400/30 rounded-full animate-spin-slow"></div>
              <div
                className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-48 h-48 border border-pink-400/20 rounded-full animate-spin-reverse"></div>
            </div>
            ...
            <div
              className="relative">
              <div
                className="absolute inset-0 bg-gradient-to-r from-purple-500 to-pink-500 rounded-full blur-xl opacity-75 group-hover:opacity-100 transition-opacity animate-pulse-slow"></div>
              <img
              ...
              />
              <div
                className="absolute -bottom-1 -right-1 w-6 h-6 bg-gradient-to-r from-green-400 to-emerald-500 rounded-full border-3 border-slate-900 shadow-[0_0_10px_rgba(52,211,153,0.8)] animate-pulse"></div>
            </div>
          </div>
          ...
          <div
            className="mt-3 flex items-center gap-2 text-sm text-purple-300/70">
            <span
              className="inline-block w-2 h-2 bg-green-400 rounded-full animate-pulse shadow-[0_0_8px_rgba(52,211,153,1)]"></span>
        ...
        {/* Chat Container */}
        <main
          className="flex-1 w-full max-w-4xl px-6 py-8 overflow-y-auto">
          <div
            className="space-y-6">
            {/* Welcome Message */}
            {messages.length === 0 && (
              <div
                ...
                <div
                  ...
                  <p
                    className="text-2xl text-purple-200 font-light italic mb-2">
                    "As
                    cartas
                    cósmicas
                    estão
                ...
                <div
                  ...
                  {[{
                    ...
                    >
                      <div
                        className="text-3xl mb-2">{suggestion.icon}</div>
                      <div
                        className="text-sm text-purple-200">{suggestion.text}</div>
                    </button>))}
                </div>
              </div>)}
            ...
            {messages.map((msg,
              ...
              >
                <div
                  className={`max-w-[75%] group ${msg.role === 'user' ?
                  ...
                  {msg.role === 'assistant' && (
                    <div
                      ...
                      <span
                        className="text-xs text-purple-300/80 font-medium">Arcangelina</span>
                    </div>)}
                  ...
                  {msg.role === 'user' && (
                    <div
                      className="flex items-center gap-2 mt-2 mr-4">
                      <span
                        className="text-xs text-purple-300/60">Você</span>
                    </div>)}
                </div>
              </div>))}
            <div
        ...
        <footer
          ...
          <div
            className="mt-4 text-center text-xs text-purple-400/50">
            Powered
            by
            Local
            AI
